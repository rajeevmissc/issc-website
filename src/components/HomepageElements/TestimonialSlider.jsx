      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="sm:text-left text-center">
            <BodyText className="text-red-500 font-bold border border-red-500 px-3 py-1 rounded-md uppercase tracking-wide">
              Testimonials
            </BodyText>
            <Heading2 className="text-4xl font-bold mt-3">What Our Customers Say</Heading2>
           ...
           >
             <div className="flex items-center gap-3 mb-3">
               ...
               <div className="text-left">
                 <Heading4 className={`font-semibold text-lg ${index === 1 ? "text-black" : "text-black group-hover:text-white"}`}>
                   {testimonial.name}
                 </Heading4>
                 <BodyText className={`text-sm ${index === 1 ? "text-gray-800" : "text-gray-800 group-hover:text-gray-800"}`}>
                   {testimonial.role}
                 </BodyText>
               </div>
             </div>
             ...
             {/* Testimonial Content */}
             <BodyText className="text-left py-3 leading-relaxed group-hover:text-gray-200">{testimonial.feedback}</BodyText>
