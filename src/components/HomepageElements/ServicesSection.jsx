...
const services = [
  ...
  { title: "Accounting Advisory", description: "Comprehensive accounting solutions including Transaction Advisory, Office of the CFO and Accounting Standards Implementation", icon: <FaCalculator />, image: acounting },
  ...
  { title: "Taxation", description: "Preparation of Tax returns and Tax planning advisory", icon: <FaMoneyCheckAlt />, image: tax_image },
